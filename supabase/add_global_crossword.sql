-- Run once in the Supabase SQL Editor after deploying Global Sojourn and Crossword Chronicle.
-- This preserves every existing student, section, and score while enabling both new boards.
...
alter table public.rizal_arcade_scores
  add constraint rizal_arcade_scores_game_id_check
    check (game_id in ('values', 'novels', 'codebreaker', 'scholar', 'hearts', 'museum', 'global', 'crossword')),
