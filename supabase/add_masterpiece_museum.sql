-- Run once in the Supabase SQL Editor after deploying Masterpiece Museum.
-- This preserves every existing student, section, and score.
...
alter table public.rizal_arcade_scores
  add constraint rizal_arcade_scores_game_id_check
    check (game_id in ('values', 'novels', 'codebreaker', 'scholar', 'hearts', 'museum')),
