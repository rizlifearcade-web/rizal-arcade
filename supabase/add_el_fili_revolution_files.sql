-- Run once in the Supabase SQL Editor after deploying El Fili: Revolution Files.
-- This preserves existing students, sections, and scores while enabling its leaderboard.
...
alter table public.rizal_arcade_scores
  add constraint rizal_arcade_scores_game_id_check
    check (game_id in ('values', 'novels', 'codebreaker', 'scholar', 'hearts', 'museum', 'global', 'revolution', 'crossword')),
