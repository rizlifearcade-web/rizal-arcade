-- Run once in the Supabase SQL Editor after deploying Hearts & Horizons.
-- This migration preserves all existing students, sections, and scores.
...
alter table public.rizal_arcade_scores
  add constraint rizal_arcade_scores_game_id_check
    check (game_id in ('values', 'novels', 'codebreaker', 'scholar', 'hearts')),
