-- Repair all ten game score boards without deleting existing scores.
begin;
set local lock_timeout = '5s';
-- Apply before deploying the Dapitan score submission UI.
-- This preserves students, sections, scores, and existing authorization rules.
...
alter table public.rizal_arcade_scores
  add constraint rizal_arcade_scores_game_id_check
    check (game_id in ('values', 'novels', 'codebreaker', 'scholar', 'hearts', 'museum', 'global', 'dapitan', 'revolution', 'crossword')),
